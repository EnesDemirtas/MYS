                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                        ...
                                        @if (session('tip') == 'Çalışan')
                                            ...
                                            <div class="row">
                                                        ...
                                                        <div class="info bg-light">
                                                            <div class="row">
                                                                <div class="col-md-11 mx-auto">
                                                                    <span
                                                                        class="badge badge-primary font-weight-bold w-100 te"
                                                                        style="font-size:20px;">Kişisel Bilgiler</span>
                                                                    <div class="row mt-2">
                                                                        <div class="col-md-3">
                                                                            <div class="form-group">
                                                                                <label for="ad">Ad</label>
                                                                                <input onkeypress="guncelleGoster()"
                                                                                    type="text"
                                                                    ...
                                                                    <hr>
                                                                    <span
                                                                        class="badge badge-primary font-weight-bold w-100"
                                                                        style="font-size:20px;">İletişim
                                                                        Bilgileri</span>
                                                                    <div class="row">
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                                    ...
                                                                    <span
                                                                        class="badge badge-primary font-weight-bold w-100"
                                                                        style="font-size:20px;">Adres Bilgileri</span>
                                                                    <div class="row">
                                                                        <div class="col-md-3">
                                                                            <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <textarea onkeypress="guncelleGoster()" class="form-control mb-4" style="resize:none;" id="cevadres"
                                                                    ...
                                                                    <span
                                                                        class="badge badge-primary font-weight-bold w-100"
                                                                        style="font-size:20px;">Hesap Bilgileri</span>
                                                                    <div class="row">
                                                                        <div class="col-md-4">
                                                                            <div class="form-group">
                                                ...
                                                <div
                                                    class="account-settings-footer justify-content-center fixed-bottom hide d-none">
                                                    <div
                                                        class="as-footer-container text-center justify-content-center">
                                ...
                                @else
                                    <div class="row">
                                        <div class="col-3 d-flex flex-column" style="height: 200px;">
                                            <div class="profilepic" style="border-radius: 20%">
                                                <img class="profilepic__image" alt="Profil Resmi"
                                                    src="@if (is_null(session('kullanici')->mphoto)) {{ asset('assets/img/90x90.jpg') }} @else {{ Storage::url('photos/') . session('kullanici')->mphoto }} @endif"
                                                    width="100%" height="200px" />
                                                <div class="profilepic__content">
                                                    <span class="profilepic__icon"><i
                                                            class="fas fa-camera"></i></span>
                                                    <form method="post"
                                                        ...
                                                        <input type="file" id="actual-btn" name="photo"
                                                            onchange="javascript:document.getElementById('upload_button').hidden = false;"
                                                            hidden />
                                                        <label for="actual-btn" class="profilepic__text"> Fotoğrafı
                                                            Düzenle</label>
                                                </div>
                                            </div>
                                            <div id="upload_button_div"><button type="submit" id="upload_button"
                                                    hidden>Yükle</button></div>
                                            </form>
                                        </div>

                                        <div class="col-9 px-4">
                                            <form id="kisiBilgileri" class="section contact" method="post"
                                                action="{{ route('musteri.guncelle.profil', ['mtcknvno' => $musteri->mtcknvno]) }}">
                                                @csrf
                                                @method('put')
                                                <div class="info bg-light">
                                                    <div class="row">
                                                        <div class="col-md-11 mx-auto text-center">
                                                            <span
                                                                class="badge badge-primary font-weight-bold w-100 mb-2"
                                                                style="font-size:20px;">Kişisel Bilgiler</span>
                                                            <div class="row pb-2">
                                                                <div class="col-md-3">
                                                            ...
                                                            <span
                                                                class="badge badge-primary font-weight-bold w-100 mb-2"
                                                                style="font-size:20px;">İletişim Bilgileri</span>
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="location">Adres</label>
                                                                        <textarea onkeypress="guncelleGoster()" class="form-control mb-4" style="resize:none;" id="madres"
                                                            ...
                                                            <span
                                                                class="badge badge-primary font-weight-bold w-100 mb-2"
                                                                style="font-size:20px;">Firma Bilgileri</span>
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                            ...
                                                            <div class="row text-center">
                                                                <div class="col">
                                                                    <div>
                                                                        <a class="btn btn-danger"
                                                                            href="{{ route('profile.delete', ['tip' => session('tip'), 'id' => $musteri->id]) }}">Hesabı
                                                                            Sil</a>
                                                                    </div>
                                                                </div>
                                                            </div>
