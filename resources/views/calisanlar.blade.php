                                ...
                                <tbody>
                                    @unless(count($calisanlar) == 0)
                                        ...
                                        <tr id="calisan-{{ $calisan->ctckn }}">
                                            ...
                                            <td><a><span class="gorev"> @php if($calisan->cunvani == NULL) {echo "Belirtilmemiş";} @endphp</span></a></td>
