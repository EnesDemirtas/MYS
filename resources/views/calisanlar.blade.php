                                                    ...
                                                    <li class="contacts-block__item">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                            ...
                                                            <line x1="3" y1="10" x2="21"
                                                                y2="10"></line>
                                                        </svg><span id="modal-dogum">Jan 20, 1989</span>
                                                    </li>
                                                    <li class="contacts-block__item">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" viewBox="0 0 24 24" fill="none"
                                                        ...
                                                        </svg><span id="modal-lokasyon">New York, USA</span>
                                                    </li>
                                                    <li class="contacts-block__item">
                                                        <a href="mailto:example@mail.com"><svg
                                                            ...
                                                            </svg><span id="modal-eposta">Jimmy@gmail.com</span></a>
                                                    </li>
                                                    <li class="contacts-block__item">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                            height="24" viewBox="0 0 24 24" fill="none"
                                                        ...
                                                        </svg><span id="modal-cep"> +1 (530) 555-12121</span>
                                                    </li>
                                                    <li class="contacts-block__item">
                                        ...
                                        @foreach ($calisanlar as $calisan)
                                            <tr id="calisan-{{ $calisan->ctckn }}">
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <p class="align-self-center mb-0 user-name">
                                                            {{ $calisan->cadi . ' ' . $calisan->csoyadi }} </p>
                                                    </div>
                                                </td>
                                                ...
                                                <td><a href="tel:{{ $calisan->ctel }}"><span class="inv-email"><svg
                                                        ...
                                                        href="mailto:{{ $calisan->ceposta }}"><span
                                                            style="margin-left: 2px;" class="inv-email"><svg
                                                                xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            ...
                                                            <a data-toggle="modal" role="button"
                                                                ...
                                                                onclick="kisiBilgileri({{ $calisan->ctckn }})"><svg
                                                                    style="width:23px; fill:#0e63ec !important;"
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu"
                                                                    ...
                                                                    <a class="dropdown-item action-edit"
                                                                        ...
                                                                        href="{{ route('calisan.duzenle', ['ctckn' => $calisan->ctckn]) }}"><svg
                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                            width="24" height="24"
                                                                            viewBox="0 0 24 24" fill="none"
                                                                            stroke="currentColor" stroke-width="2"
                                                                    ...
                                                                    <form method="post"
                                                                        action="{{ route('calisan.sil', ['ctckn' => $calisan->ctckn]) }}">
                                                                        @csrf
                                                                        @method('delete')
                                                                        <button
