...
<head>
    ...
    <title>MYS - TEKLİF YÖNETİMİ</title>
                ...
                <div class="page-header">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);">Düzenle</a></li>
                        </ol>
                    </nav>
                </div>
                                                ...
                                                <div class="row justify-content-between">
                                                    ...
                                                    <div class="col-xl-5 invoice-address-client">
                                                        ...
                                                        <div class="invoice-address-client-fields">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="client-address" class="col-sm-3 col-form-label col-form-label-sm">Adress</label>
                                                                <div class="col-sm-9">
                                            ...
                                            <div class="invoice-detail-total">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group row invoice-created-by">
                                                            <label for="payment-method-bank-name" class="col-sm-3 col-form-label col-form-label-sm">Banka İsmi:</label>
                                                            <div class="col-sm-9">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 align-self-center">
                                                        ...
                                                        <div class="form-group row invoice-note">
                                                            <label for="invoice-detail-notes" class="col-sm-12 col-form-label col-form-label-sm">Notlar:</label>
                                                            <div class="col-sm-12">
                                                                <textarea class="form-control" id="invoice-detail-notes" placeholder='Notes - For example, "Thank you for doing business with us"' style="height: 88px;">Bizimle çalıştığınız için teşekkürler.</textarea>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <div class="dropdown selectable-dropdown invoice-select">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="currencyDropdown">
                                                        <a class="dropdown-item" data-img-value="{{ asset('assets/img/flag-us.svg ') }}" data-value="USD - US Dollar" href="javascript:void(0);"><img src="{{ asset('assets/img/flag-us.svg ') }}" class="flag-width" alt="flag"> USD - Amerikan Doları</a>
                                                        <a class="dropdown-item" data-img-value="{{ asset('assets/img/flag-gbp.svg') }}" data-value="GBP - British Pound" href="javascript:void(0);"><img src="{{ asset('assets/img/flag-gbp.svg') }}" class="flag-width" alt="flag"> GBP - İngiliz Sterlini</a>
                                                        <a class="dropdown-item" data-img-value="{{ asset('assets/img/flag-idr.svg') }}" data-value="IDR - Indonesian Rupiah" href="javascript:void(0);"><img src="{{ asset('assets/img/flag-idr.svg') }}" class="flag-width" alt="flag"> IDR - Endonezya Rupisi</a>
                                                        <a class="dropdown-item" data-img-value="{{ asset('assets/img/flag-inr.svg') }}" data-value="INR - Indian Rupee" href="javascript:void(0);"><img src="{{ asset('assets/img/flag-inr.svg') }}" class="flag-width" alt="flag"> INR - Hindistan Rupisi</a>
                                                        <a class="dropdown-item" data-img-value="{{ asset('assets/img/flag-brl.svg') }}" data-value="BRL - Brazilian Real" href="javascript:void(0);"><img src="{{ asset('assets/img/flag-brl.svg') }}" class="flag-width" alt="flag"> BRL - Brezilya Reali</a>
                                                        <a class="dropdown-item" data-img-value="{{ asset('assets/img/flag-de.svg ') }}" data-value="EUR - Germany (Euro)" href="javascript:void(0);"><img src="{{ asset('assets/img/flag-de.svg ') }}" class="flag-width" alt="flag"> EUR - Euro</a>
                                                        <a class="dropdown-item" data-img-value="{{ asset('assets/img/flag-try.svg') }}" data-value="TRY - Turkish Lira" href="javascript:void(0);"><img src="{{ asset('assets/img/flag-try.svg') }}" class="flag-width" alt="flag"> TRY - Türk Lirası</a>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <div class="form-group mb-0">
                                                            ...
                                                            <div class="dropdown selectable-dropdown invoice-tax-select">
                                                                <a id="currencyDropdown" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <span class="selectable-text">Toplamda</span> <span class="selectable-arrow"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg></span></a>
                                                                <div class="dropdown-menu" aria-labelledby="currencyDropdown">
                                                                    <a class="dropdown-item" data-value="Deducted" href="javascript:void(0);">Deducted</a>
                                                                    <a class="dropdown-item" data-value="Kalem Başına" href="javascript:void(0);">Kalem Başına</a>
                                                                    <a class="dropdown-item" data-value="Toplamda" href="javascript:void(0);">Toplamda</a>
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="form-group mb-0">
                                                            ...
                                                            <div class="dropdown selectable-dropdown invoice-discount-select">
                                                                ...
                                                                <div class="dropdown-menu" aria-labelledby="currencyDropdown">
                                                                    ...
                                                                    <a class="dropdown-item" data-value="Miktar" href="javascript:void(0);">Miktar</a>
                                                                    <a class="dropdown-item" data-value="Yok" href="javascript:void(0);">Yok</a>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group mb-0 discount-amount">
                                                            ...
                                                            <input type="number" class="form-control input-rate" id="rate" placeholder="Oran" value="25">
                                                        </div>

                                                        <div class="form-group mb-0 discount-percent" style="display: none;">
                                                            <label for="rate">Yüzde</label>
                                                            <input type="number" class="form-control input-rate" id="rate" placeholder="Oran" value="10">
                                                        </div>
                                                    </div>
