                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="javascript:void(0);"
                                        style="color:whitesmoke">Teklif Yönetimi</a></li>
                                <li class="breadcrumb-item"><a href="javascript:void(0);"
                                        style="color:whitesmoke">Ekle</a></li>
                            </ol>
                        </nav>
                    </div>
                    <!-- CONTENT AREA -->
                                                ...
                                                <div class="invoice-detail-body">
                                                    ...
                                                    <div class="invoice-detail-items">
                                                        ...
                                                        <input type="text" style="display:none;" id="yenisi"
                                                            value="1">
                                                        <div class="tekSilinen" id="tekSilinen"
                                                            style="display:none;">
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 fiyat_hesapla text-center">
                                                                ...
                                                                <p class="font-weight-bold alert alert-danger mt-1"
                                                                    id="fiyat_uyarisi1" style="display:none;">Lütfen
                                                                    ürün
                                                                    için geçerli fiyat bilgisi girdiğinizden emin
                                                                    olunuz!
                                                                </p>
                                                                <p class="font-weight-bold alert alert-danger mt-1"
                                                                    id="miktar_uyarisi1" style="display:none;">Lütfen
                                                                    ürün
                                                                    için geçerli miktar bilgisi girdiğinizden emin
                                                                    olunuz!
                                                                </p>
                                                                <p class="font-weight-bold alert alert-danger mt-1"
                                                                ...
                                                                <div id="totalrow" style="display:block;">
                                                                    <div
                                                                        ...
                                                                        <div class="invoice-summary-label">Ara Toplam
                                                                        </div>
