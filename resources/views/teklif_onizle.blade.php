                    ...
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);"
                                    style="color:whitesmoke">Önizle</a></li>
                        </ol>
                    </nav>
                </div>
                                                            ...
                                                            <div class="inv--head-section inv--detail-section">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-6 col-12 mr-auto">
                                                                        <div class="d-flex">
                                                                            ...
                                                                            <h3 class="in-heading align-self-center">
                                                                                {{ $sirketismi }}</h3>
                                                                            <input type="hidden" name="sirketismi"
                                                                                value="{{ $sirketismi }}">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-6 align-self-center mt-3">
                                                                        <p class="inv-street-addr">{{ $yetkiliismi }}
                                                                        </p>
                                                                        <p class="inv-street-addr">{{ $musteriadres }}
                                                                        </p>
                                                                        <p class="inv-email-address">{{ $yetkiliemail }}
                                                                        </p>
                                                                        <p class="inv-email-address">
                                                                            {{ $musteritelefon }}</p>
                                                                        <input type="hidden" name="yetkiliismi"
                                                                            value="{{ $yetkiliismi }}">
                                                                        <input type="hidden" name="musteriadres"
                                                                            value="{{ $musteriadres }}">
                                                                        <input type="hidden" name="yetkiliemail"
                                                                            value="{{ $yetkiliemail }}">
                                                                        <input type="hidden" name="musteritelefon"
                                                                            value="{{ $musteritelefon }}">
                                                                    </div>
                                                                    <div
                                                                        class="col-sm-6 align-self-center mt-3 text-sm-right">
                                                                        <p class="inv-created-date"><span
                                                                                class="inv-title">Teklif Tarihi :
                                                                            </span> <span
                                                                                class="inv-date">{{ $teklif_baslangic_tarihi }}</span>
                                                                        </p>
                                                                        <input type="hidden"
                                                                            name="teklif_baslangic_tarihi"
                                                                            value="{{ $teklif_baslangic_tarihi }}">
                                                                        <p class="inv-due-date"><span
                                                                                class="inv-title">Bitiş Tarihi : </span>
                                                                            <span
                                                                                class="inv-date">{{ $teklif_bitis_tarihi }}</span>
                                                                        </p>
                                                                        <input type="hidden" name="teklif_bitis_tarihi"
                                                                            value="{{ $teklif_bitis_tarihi }}">
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xl-8 col-lg-7 col-md-6 col-sm-4">
                                                                        ...
                                                                        <p class="inv-street-addr">Muratpaşa, Kızılarık
                                                                            ...
                                                                            07310 Antalya</p>
                                                                        <p class="inv-email-address">business@sbe.com
                                                                        </p>
                                                                        <p class="inv-email-address">+90 (242) 326 10
                                                                            11</p>
                                                                    </div>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="inv--payment-info">
                                                                            <p><span class=" inv-subtitle">Banka
                                                                                    Adı:</span>
                                                                                <span>{{ $banka_adi }}</span></p>
                                                                            <input type="hidden" name="banka_adi"
                                                                                value="{{ $banka_adi }}">
                                                                            <p><span class=" inv-subtitle">Hesap
                                                                                    Numarası: </span>
                                                                                <span>{{ $hesap_numarasi }}</span></p>
                                                                            <input type="hidden"
                                                                                name="hesap_numarasi"
                                                                                value="{{ $hesap_numarasi }}">
                                                                            <p><span class=" inv-subtitle">SWIFT
                                                                                    code:</span>
                                                                                <span>{{ $swift_kodu }}</span></p>
                                                                            <input type="hidden" name="swift_kodu"
                                                                                value="{{ $swift_kodu }}">
                                                                            <p><span class=" inv-subtitle">Ülke:
                                                                                </span>
                                                                                <span>{{ $ulke }}</span></p>
                                                                            <input type="hidden" name="ulke"
                                                                                value="{{ $ulke }}">
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="inv--note">
                                                                ...
                                                                <div class="row mt-1">
                                                                    <label for="invoice-detail-notes"
                                                                        class="col-sm-12 col-form-label col-form-label-sm">Müşteri
                                                                        Notu:</label>
                                        ...
                                        <div class="invoice-actions-btn">
                                            ...
                                            <div class="invoice-action-btn">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-12 col-md-3 col-sm-6">
                                                        <a href="/teklif_duzenle"
                                                            class="btn btn-dark btn-edit">Düzenle</a>
                                                    </div>
                                                </div>
                                            </div>
