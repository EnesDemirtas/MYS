                ...
                <div class="page-header">
                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);">Teklifler</a></li>
                        </ol>
                    </nav>
                </div>
                            ...
                            <table id="invoice-list" class="table table-hover" style="width:100%">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><a href="teklif_onizle.html"><span class="inv-number">#098424</span></a></td>
                                        <td>
                                            <div class="d-flex">
                                        ...
                                        <td><span class="badge badge-success inv-status">Ödendi</span></td>
                                        <td>
                                            <div class="dropdown">
                                    ...
                                    <tr>
                                        <td class="checkbox-column"> 1 </td>
                                        <td><a href="teklif_onizle.html"><span class="inv-number">#095841</span></a></td>
                                        <td>
                                            <div class="d-flex">
                                                <div class="usr-img-frame mr-2 rounded-circle">
                                                    <img alt="avatar" class="img-fluid rounded-circle" src="assets/img/90x90.jpg">
                                        ...
                                        <td><span class="badge badge-danger inv-status">İşleniyor</span></td>
                                        <td>
                                            <div class="dropdown">
                                                <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-horizontal"><circle cx="12" cy="12" r="1"></circle><circle cx="19" cy="12" r="1"></circle><circle cx="5" cy="12" r="1"></circle></svg>
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink2">
                                                    <a class="dropdown-item action-edit" href="/teklif_duzenle"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3"><path d="M12 20h9"></path><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path></svg>Düzenle</a>
                                                    <a class="dropdown-item action-delete" href="javascript:void(0);"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg>Sil</a>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="checkbox-column"> 1 </td>
                                        <td><a href="teklif_onizle.html"><span class="inv-number">#091768</span></a></td>
                                        <td>
                                            <div class="d-flex">
                                                <div class="usr-img-frame mr-2 rounded-circle">
                                                    <img alt="avatar" class="img-fluid rounded-circle" src="assets/img/90x90.jpg">
                                    ...
                                    <tr>
                                        <td class="checkbox-column"> 1 </td>
                                        <td><a href="teklif_onizle.html"><span class="inv-number">#089472</span></a></td>
                                        <td>
                                            <div class="d-flex">
                                                <div class="usr-img-frame mr-2 rounded-circle">
                                                    <img alt="avatar" class="img-fluid rounded-circle" src="assets/img/90x90.jpg">
                                    ...
                                    <tr>
                                        <td class="checkbox-column"> 1 </td>
                                        <td><a href="teklif_onizle.html"><span class="inv-number">#087916</span></a></td>
                                        <td>
                                            <div class="d-flex">
                                                <div class="usr-img-frame mr-2 rounded-circle">
                                                    <img alt="avatar" class="img-fluid rounded-circle" src="assets/img/90x90.jpg">
                                    ...
                                    <tr>
                                        <td class="checkbox-column"> 1 </td>
                                        <td><a href="teklif_onizle.html"><span class="inv-number">#086773</span></a></td>
                                        <td>
                                            <div class="d-flex">
                                                <div class="usr-img-frame mr-2 rounded-circle">
                                                    <img alt="avatar" class="img-fluid rounded-circle" src="assets/img/90x90.jpg">
                                    ...
                                    <tr>
                                        <td class="checkbox-column"> 1 </td>
                                        <td><a href="teklif_onizle.html"><span class="inv-number">#086643</span></a></td>
                                        <td>
                                            <div class="d-flex">
                                                <div class="usr-img-frame mr-2 rounded-circle">
                                                    <img alt="avatar" class="img-fluid rounded-circle" src="assets/img/90x90.jpg">
                                    ...
                                    <tr>
                                        <td class="checkbox-column"> 1 </td>
                                        <td><a href="teklif_onizle.html"><span class="inv-number">#084743</span></a></td>
                                        <td>
                                            <div class="d-flex">
                                                <div class="usr-img-frame mr-2 rounded-circle">
                                                    <img alt="avatar" class="img-fluid rounded-circle" src="assets/img/90x90.jpg">
                                    ...
                                    <tr>
                                        <td class="checkbox-column"> 1 </td>
                                        <td><a href="teklif_onizle.html"><span class="inv-number">#082693</span></a></td>
                                        <td>
                                            <div class="d-flex">
                                                <div class="usr-img-frame mr-2 rounded-circle">
                                                    <img alt="avatar" class="img-fluid rounded-circle" src="assets/img/90x90.jpg">
                                    ...
                                    <tr>
                                        <td class="checkbox-column"> 1 </td>
                                        <td><a href="teklif_onizle.html"><span class="inv-number">#081681</span></a></td>
                                        <td>
                                            <div class="d-flex">
                                                <div class="usr-img-frame mr-2 rounded-circle">
                                                    <img alt="avatar" class="img-fluid rounded-circle" src="assets/img/90x90.jpg">
                                    ...
                                    <tr>
                                        <td class="checkbox-column"> 1 </td>
                                        <td><a href="teklif_onizle.html"><span class="inv-number">#081452</span></a></td>
                                        <td>
                                            <div class="d-flex">
                                                <div class="usr-img-frame mr-2 rounded-circle">
                                                    <img alt="avatar" class="img-fluid rounded-circle" src="assets/img/90x90.jpg">
                                    ...
                                    <tr>
                                        <td class="checkbox-column"> 1 </td>
                                        <td><a href="teklif_onizle.html"><span class="inv-number">#081451</span></a></td>
                                        <td>
                                            <div class="d-flex">
                                                <div class="usr-img-frame mr-2 rounded-circle">
                                                    <img alt="avatar" class="img-fluid rounded-circle" src="assets/img/90x90.jpg">
