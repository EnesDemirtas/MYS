                        ...
                        <form class="text-left" method="POST" action=" {{route('register') }} ">
                            ...
                            <div class="form">
                                ...
                                <div id="kurumsal">
                                    ...
                                    <div class="col-6"> <!-- İkinci Kolon Başlangıç -->
                                        <div id="tckn-field" class="field-wrapper input">
                                            ...
                                            <input id="tckn" name="tckn" type="text" class="form-control" placeholder="TCKN">
                                                @error('tckn')
                                                <p class="text-danger mt-1">{{ $message }}</p>
                                                @enderror
                                        </div>
                                        ...
                                        <div id="telefon-field" class="field-wrapper input mb-2">
                                            ...
                                            <input id="telefon" name="telefon" type="text" placeholder="Telefon Numarası">
                                            @error('telefon')
                                                <p class="text-danger mt-1">{{ $message }}</p>
                                                @enderror
                                        </div>
                                    ...
                                    <div id="adres-field" class="row field-wrapper input mb-2">
                                        <div class="col-2 pr-0">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="70" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-map-pin">
