                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-4 mb-4">
                                                    <div class="card text-white card-has-bg click-col" style="background-image:url('https://source.unsplash.com/600x900/?tech');">
                                                        ...
                                                        <div class="card-img-overlay d-flex flex-column">
                                                            <div class="card-body">
                                                                <h4 class="card-meta mb-2">{{$bakimformu->form_adi}} Bakımı</h4>
                                                                <h4 class="card-title mt-0 "><span class="text-white">Detaylar</span></h4>
                                                                <small><i class="far fa-clock"></i> {{ now()->year; }}</small>
                                                            </div>
                                                            <div class="card-footer">
                                                                <div class="media">
                                                                    <img class="mr-3 rounded-circle" src="{{ asset('assets/img/sbe_logo.png') }}" alt="Generic placeholder image" style="max-width:100px">
                                                                    <div class="media-body">
                                                                        <h6 class="my-0 text-white d-block">Sadık BOZDEMİR</h6>
