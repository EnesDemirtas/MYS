                                ...
                                <section class="wrapper">
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-4 mb-4">
                                                ...
                                                <img class="card-img d-none" src="https://source.unsplash.com/600x900/?tech" alt="Detaylar">
                                                    <div class="card-img-overlay d-flex flex-column">
                                                        <div class="card-body">
                                                            <small class="card-meta mb-2">Kalorifer Kazanı Bakımı</small>
                                            ...
                                            <!-- İkinci Card -->
                                            <div class="col-sm-12 col-md-6 col-lg-4 mb-4">
                                                <div class="card text-white card-has-bg click-col" style="background-image:url('https://source.unsplash.com/600x900/?computer');">
                                                <img class="card-img d-none" src="https://source.unsplash.com/600x900/?computer" alt="Detaylar">
                                                    <div class="card-img-overlay d-flex flex-column">
                                                        <div class="card-body">
                                                            <small class="card-meta mb-2">Kompresör Bakımı</small>
                                                            <h4 class="card-title mt-0 "><a class="text-white" herf="#">Detaylar</a></h4>
                                                            <small><i class="far fa-clock"></i> {{ now()->year; }}</small>
                                                        </div>
                                                        <div class="card-footer">
                                            ...
                                            <!-- Üçüncü Card -->
                                            <div class="col-sm-12 col-md-6 col-lg-4 mb-4">
                                                <div class="card text-white card-has-bg click-col" style="background-image:url('https://source.unsplash.com/600x900/?street');">
                                                <img class="card-img d-none" src="https://source.unsplash.com/600x900/?street" alt="Detaylar">
                                                    <div class="card-img-overlay d-flex flex-column">
                                                        <div class="card-body">
                                                            <small class="card-meta mb-2">Yangın Tüpü Bakımı</small>
                                                            <h4 class="card-title mt-0 "><a class="text-white" herf="#">Detaylar</a></h4>
                                                            <small><i class="far fa-clock"></i> {{ now()->year; }}</small>
                                                        </div>
                                                        <div class="card-footer">
