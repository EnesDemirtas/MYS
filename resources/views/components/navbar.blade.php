<div class="topbar-nav header navbar" role="banner">
    <nav id="topbar">
        ...
        <ul class="list-unstyled menu-categories" id="topAccordion">
            ...
            <li class="menu single-menu">
                <a href="/randevu_yonetimi"  aria-expanded="false" class="dropdown-toggle autodroprown">
                    <div class="">
                ...
                <ul class="collapse submenu list-unstyled" id="menu2" data-parent="#topAccordion">
                    ...
                    <li class="sub-sub-submenu-list">
                        <a href="#sub-sub-category"  aria-expanded="false" class="dropdown-toggle"> Submenu 3 <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg> </a>
            ...
            <li class="menu single-menu">
                <a href="/teklif_yonetimi"  aria-expanded="false" class="dropdown-toggle autodroprown">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
