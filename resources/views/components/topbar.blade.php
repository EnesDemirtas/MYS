<div class="header-container">
    <header class="header navbar navbar-expand-sm">
        ...
        <div class="nav-logo align-self-center">
            <a class="navbar-brand" @if (session('kullanici')->cyetki == '2') href="{{route('anasayfa.index')}}" @endif> <span class="navbar-brand-name">SBE Mühendislik - Müşteri Yönetim Sistemi</span></a>
        </div>
