    ...
    buttons: [
        {
            ...
            action: function(e, dt, node, config ) {
                window.location = 'teklif_ekle.html';
            }
        }
    ],
    "order": [[ 1, "asc" ]],
...
$("div.toolbar").html('<button class="dt-button dt-delete btn btn-danger btn-sm" tabindex="0" aria-controls="invoice-list"><span>Sil</span></button>');
